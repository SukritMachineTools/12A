...
//  lcd.print("   ");
  ...
  lcd.setCursor(10, 1);
  lcd.print("PART:" + String(counter1) + "  ");
...

{
  if (digitalRead(optoPinm1) == LOW) {
    ...
    if (mrunning) {
      ...
      lcd.setCursor(0, 1);
      lcd.print("Timer:" +String(mhr) + ":" + String(mmin) + ":" + String(mcycleTime % 60));
      // EEPROM.write(mcycleadd, mmin);
      EEPROM.put(mcycleadd, mmin);  // Write the integer to the first four slots
    }  //mode2
    ...
    if (srunning) {
      ...
      lcd.setCursor(0, 1);
      lcd.print("Timer:" +String(shr) + ":" + String(smin) + ":" + String(scycleTime % 60));
